  ...
  },
  {
    ...
    mega: {
      items: [
        ...
        { label: "AI Property Advisor", href: "/insights/ai-advisor", icon: <Sprout size={16} className="text-emerald-500" /> },
        { label: "Blogs", href: "/blog", icon: <Newspaper size={16} className="text-gray-600" /> },
        { label: "EMI Calculator", href: "/tools/emi-calculator", icon: <Calculator size={16} className="text-blue-500" /> },
        { label: "ROI Calculator", href: "/tools/roi-calculator", icon: <TrendingUp size={16} className="text-emerald-500" /> },
        { label: "Rental Yield", href: "/tools/rental-yield-calculator", icon: <IndianRupee size={16} className="text-gold-500" /> },
