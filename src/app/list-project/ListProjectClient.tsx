...
const BENEFITS = [
  {
    icon: Building2,
    title: "Professional Developer Profile",
    desc: "Create a comprehensive profile that builds trust and credibility with potential buyers.",
  },
  {
    icon: FileCheck,
    title: "Project Microsites",
    desc: "Dedicated pages for each project with RERA details where available, floor plans and amenities.",
  },
  {
    icon: Users,
    title: "Buyer Enquiry Forms",
    desc: "Receive structured enquiries directly from interested buyers and investors.",
  },
  {
    icon: MapPin,
    title: "City Visibility",
    desc: "Get discovered by property seekers searching in your project locations.",
  },
  {
    icon: Eye,
    title: "Location Highlights",
    desc: "Showcase nearby infrastructure, connectivity and neighbourhood advantages.",
  },
  {
    icon: BarChart3,
    title: "Market Report Opportunities",
    desc: "Access market insights and reports relevant to your project areas.",
  },
];
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 sm:pt-32 text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.08]">
              List Your{" "}
              <span className="text-gradient bg-[length:120%_auto]">Project</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Showcase your real estate projects on PropertyPointers. Build digital visibility, connect
              with serious buyers and grow your brand in India&apos;s real estate ecosystem.
            </p>
      ...
      <MotionSection className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-navy-900">
            Everything you need to grow your projects
          </h2>
        </div>
      ...
      <MotionSection className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-24">
        ...
        >
          ...
          <p className="relative mt-3 text-gray-300 max-w-xl mx-auto">
            Join the PropertyPointers ecosystem and connect with buyers, investors and market experts
            across India.
          </p>
