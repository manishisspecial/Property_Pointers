...
const BENEFITS = [
  {
    ...
    desc: "Create a detailed profile showcasing your expertise, certifications and service areas.",
  },
  {
    icon: FolderOpen,
    title: "Portfolio Showcase",
    desc: "Display your past projects and work samples to build credibility with potential clients.",
  },
  {
    icon: MapPin,
    title: "City/Category Visibility",
    desc: "Get discovered by clients searching for services in your city and specialisation.",
  },
  {
    icon: MessageSquare,
    title: "Lead Enquiry Form",
    desc: "Receive direct enquiries from buyers, developers and property owners who need your services.",
  },
  {
    icon: Users,
    title: "Real Estate Audience Reach",
    desc: "Connect with a growing community of property seekers, developers and advisors.",
  },
  {
    icon: Eye,
    title: "Early Partner Advantage",
    desc: "Join early and establish your presence as the ecosystem grows across India.",
  },
];
...
export default function ListServiceClient() {
    ...
    <main className="min-h-screen bg-gray-50 overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 sm:pt-32 text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-[1.08]">
              List Your{" "}
              <span className="text-gradient bg-[length:120%_auto]">Service</span>
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Join India&apos;s real estate ecosystem as a vendor. Get discovered by buyers, developers
              and advisors who need your professional services.
            </p>
      ...
      <MotionSection className="border-y border-gray-200 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold text-navy-900">Who can list?</h2>
          <p className="mt-4 text-gray-600 text-lg">
            PropertyPointers welcomes all real estate service providers.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {SERVICE_TYPES.map((type) => (
              <span
                key={type}
                className="rounded-full bg-navy-50 border border-navy-100 px-4 py-2 text-sm font-medium text-navy-700"
              >
                {type}
              </span>
            ))}
      ...
      <MotionSection className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <motion.div
        ...
        >
          ...
          <p className="relative mt-3 text-gray-300 max-w-xl mx-auto">
            List your service on PropertyPointers and connect with buyers, developers and advisors
            across India.
          </p>
